...
describe('App', () => {
  ...
  test('renders homepage content after authentication', async () => {
    ...
    root.render(<App />);
    await waitFor(() => {
      assert.match(div.textContent, /AI-Powered\s*Design Engineer/);
      assert.match(div.textContent, /Design engineer bridging product strategy, UX craft, and front-end execution/);
